  ...
  return (
    <div className={styles.topRow}>
      <div className={styles.buttonGroup}>
        ...
        <TextButton text="Example on my profile" onClick={() => open("https://github.com/Mohit-005?tab=overview&from=2018-12-01&to=2018-12-31#:~:text=January,Jan")} />
        <div className={styles.between} />
        <TextButton text="Example downloaded script" onClick={() => open("https://github.com/Mohit-005/github_painter/blob/main/example_script.sh")} />
        <div className={styles.between} />
        <TextButton  text="GitHub Issues" onClick={() => open("https://github.com/Mohit-005/github_painter/issues")} />
        <div className={styles.between} />
        <TextButton star text="Star on GitHub (I'm trying to beat my friend)" onClick={() => open("https://github.com/Mohit-005/github_painter")} />
        <div className={styles.between} />
